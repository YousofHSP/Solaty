...
namespace Data.Migrations
{
    ...
    [Migration("20251205100322_AddRelationship")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Relationship", b =>
                {
                    ...
                    b.Property<long>("FemaleUserInfoId")
                        .HasColumnType("bigint");

                    b.Property<long>("MaleUserInfoId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FemaleUserInfoId");

                    b.HasIndex("MaleUserInfoId");
            ...
            modelBuilder.Entity("Domain.Entities.Relationship", b =>
                {
                    b.HasOne("Domain.Entities.UserInfo", "FemaleUserInfo")
                        .WithMany("FemaleRelationships")
                        .HasForeignKey("FemaleUserInfoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.UserInfo", "MaleUserInfo")
                        .WithMany("MaleRelationships")
                        .HasForeignKey("MaleUserInfoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FemaleUserInfo");

                    b.Navigation("MaleUserInfo");
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserInfo", b =>
                {
                    b.Navigation("FemaleRelationships");

                    b.Navigation("MaleRelationships");
                });
